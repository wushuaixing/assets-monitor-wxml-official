...
* @see DESCore
*/
export function strToEnc(data, secondKey) {
	const key1 = 'yuanchengkeji';
	const key3 = 'java_http_web';
	return strEnc(data, key1, secondKey, key3);
}
/**
 * DES加密/解密
...
export function strEnc(data, firstKey, secondKey, thirdKey) {
	...
	let encData = '';
	let firstKeyBt; let secondKeyBt; let thirdKeyBt; let firstLength; let secondLength; let thirdLength;
...
function strToBt(str) {
	...
	if (leng < 4) {
		var i = 0; var j = 0; let p = 0; let q = 0;
		for (i = 0; i < leng; i++) {
...
function byteToString(byteData) {
	let str = '';
	let i; let j; let k; let m; const n = 0;
	for (i = 0; i < 4; i++) {
		let count = 0;
		for (j = 0; j < 16; j++) {
			let pow = 1;
...
function initPermute(originalData) {
	let i; let j; let k; let m; let n = 0;
